...
export declare class ClientScopes extends Resource<{
    ...
    findOne: (payload?: ({
        ...
        realm?: string | undefined;
    }) | undefined, options?: Pick<import("./agent.js").RequestArgs, "catchNotFound"> | undefined) => Promise<ClientScopeRepresentation | undefined>;
    update: (query: {
        id: string;
    } & {
        realm?: string | undefined;
    ...
    findProtocolMapper: (payload?: ({
        ...
        realm?: string | undefined;
    }) | undefined, options?: Pick<import("./agent.js").RequestArgs, "catchNotFound"> | undefined) => Promise<ProtocolMapperRepresentation | undefined>;
